          ...
          <div className="container">
            ...
            <div className="site-description">
              <p>
                ...
                well-known anonymous armory profile source for World of
                Warcraft. We aim to keep things simple and just ask for your
                character's region, server, and name and we do the rest of the
                heavy lifting. Our aim is to provide you a profile link that
                will keep you protected when you are attempting to buy, sell, or
                trade your World of Wacraft account.
              </p>
            </div>
            ...
            <div className="region">
              <Link
                to="/"
                onClick={(event) => this.handleFlagSelection(event, 'us')}
              >
                <div className="us" />
              </Link>
              <Link
                to="/"
                onClick={(event) => this.handleFlagSelection(event, 'eu')}
              >
                <div className="eu" />
              </Link>
            </div>
            ...
            <div className="footer">
              <ul>
                <li>
                  <Link to="https://www.khaccounts.net">
                    Buy Sell WoW Accounts
                  </Link>
                </li>
                <li className="none">|</li>
                <li>
                  <Link to="https://www.khaccounts.net/buy-wow-accounts">
                    Buy High End Elite Premium WoW Accounts
                  </Link>
                </li>
                <li className="none">|</li>
                <li>
                  <Link to="https://www.khaccounts.net/sell-wow-accounts">
                    Sell High End Elite Premium WoW Accounts
                  </Link>
                </li>
              </ul>
            </div>
